        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7">
            <motion.form
              ...
              className="bg-[#111827]/40 border border-white/5 rounded-[2.5rem] p-8 md:p-12 space-y-6 shadow-2xl mb-2"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-2xl p-4 focus:border-teal-400 outline-none transition-all text-white placeholder:text-gray-600"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-wider text-gray-500 ml-1">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full bg-white/5 border border-white/10 rounded-2xl p-4 focus:border-teal-400 outline-none transition-all text-white placeholder:text-gray-600 resize-none"
                />
              </div>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-5 bg-teal-400 text-black font-bold rounded-2xl flex items-center justify-center gap-3 hover:bg-teal-300 transition-all shadow-[0_0_20px_rgba(20,184,166,0.3)]"
              >
