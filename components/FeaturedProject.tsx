        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="flex-1 space-y-6">
            ...
            <p className="text-gray-400 text-lg leading-relaxed max-w-md">
              A logistics web application used to connect users and companies
              that have vehicle for transportion of goods
            </p>

            {/* Tech Tags */}
            <div className="flex flex-wrap gap-3">
              {["React ", "Expressjs"].map((tag) => (
                <span
                  key={tag}
            ...
            <Link
              // href={`/projects/expertdex`}
              href={"https://expertdex-mobile.vercel.app/"}
              className="inline-flex items-center gap-2 text-teal-400 font-semibold group/link"
            >
              visit
              <ArrowUpRight
